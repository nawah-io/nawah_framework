...
def test_extract_attr_dict_item(attr_obj):
	attr_val = _extract_attr(scope=attr_obj, attr_path='dict_item1.dict_child2')
...
def test_extract_attr_nested_obj_list_item(attr_obj):
	attr_val = _extract_attr(scope=attr_obj, attr_path='nested_obj.list:1.item2')
	assert attr_val == 'val2'


def test_extract_attr_nested_obj_dict_item(attr_obj):
	attr_val = _extract_attr(scope=attr_obj, attr_path='$__nested_obj.dict.list:0')
